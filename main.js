...
yesBtn.addEventListener("click", () => {
  question.innerHTML = "I'm Soooooo SORRYYYYYY";
...
gif.style.width = "400px"; 
  ...
  yesBtn.addEventListener("click", () => {
    question.innerHTML = "Yeheeee!! Maann gaiiiiiiii";
  ...
  noBtn.addEventListener("click", () => {
    ...
    noBtn.addEventListener("click", () => {
      ...
      noBtn.addEventListener("click", () => {
        question.innerHTML = "Manjao naaaa Pleaseeee! saab thik ho jaigaaa pleaseeeeee";
